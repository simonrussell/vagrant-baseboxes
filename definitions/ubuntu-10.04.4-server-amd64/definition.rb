...
#ISO_MD5           = "#{Digest::MD5.file("#{CURRENT_DIR}/../../iso/ubuntu-10.04.4-server-amd64.iso").hexdigest}"
...
Veewee::Session.declare( {
  ...
  :iso_src              => "http://mirror.internode.on.net/pub/ubuntu/releases/10.04.4/ubuntu-10.04.4-server-amd64.iso",
