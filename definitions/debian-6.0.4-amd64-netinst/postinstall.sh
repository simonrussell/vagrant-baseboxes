...
apt-get -y install ruby1.9.1 ruby1.9.1-dev libruby1.9.1 ri1.9.1

# Install Chef & Puppet
gem1.9.1 install chef puppet --no-ri --no-rdoc

# SETUP rubygems in the path
echo 'PATH="/var/lib/gems/1.9.1/bin:$PATH"' > /etc/profile.d/gem_path.sh
